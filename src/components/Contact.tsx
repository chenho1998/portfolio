...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // In a real app, reset form status after some time
    setTimeout(() => {
      setFormStatus({
        submitted: false,
        success: false,
            ...
            <div className="card h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full text-gray-800 dark:text-gray-200 hover:bg-blue-100 dark:hover:bg-blue-900 hover:text-blue-600 dark:hover:text-blue-300 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
